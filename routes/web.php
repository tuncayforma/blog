...
Route::prefix('admin')-> middleware('isAdmin')->name('admin.')->group(function (){
    ...
    //Article Route
    Route::get('makaleler/silinenler','App\Http\Controllers\Back\ArticleController@trashed')->name('trashed');
    Route::resource('makaleler','App\Http\Controllers\Back\ArticleController');
    Route::get('/switch/{id}/','App\Http\Controllers\Back\ArticleController@switch')->name('switch');
    Route::get('/delete/{id}/','App\Http\Controllers\Back\ArticleController@delete')->name('delete');
    Route::get('/harddelete/{id}/','App\Http\Controllers\Back\ArticleController@hardDelete')->name('hardDelete');
    ...
    Route::get('/category/getdata/{id}/','App\Http\Controllers\Back\CategoryController@getdata')->name('category.getdata');
    //Page Route
    ...
    Route::get('/sayfalar/duzenle/{id}','App\Http\Controllers\Back\PageController@update')->name('page.update');
    Route::post('/sayfalar/duzenle/{id}','App\Http\Controllers\Back\PageController@updatepost')->name('page.update.post');
    ...
    Route::get('sayfa/switch/{id}/','App\Http\Controllers\Back\PageController@switch')->name('page.switch');
    //Ayarlar
