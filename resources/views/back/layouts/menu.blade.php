...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link @if(Request::segment(2)=='makaleler') collapse @else in  @endif" href="{{asset('back/')}}/#" data-toggle="collapse" data-target="#collapseTwo"
        ...
        <!-- Nav Item - Utilities Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link @if(Request::segment(2)=='sayfalar') collapse @else in  @endif" href="{{asset('back/')}}/#" data-toggle="collapse" data-target="#collapsePage"
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="{{asset('back/')}}/#" data-toggle="modal" data-target="#logoutModal">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{route('homepage')}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-home fa-sm text-white-50"></i> Siteyi Görüntüle</a>
                </div>
