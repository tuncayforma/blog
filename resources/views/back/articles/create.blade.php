            ...
            <div class="container px-5 my-5">
                <form method="post" action="{{route('admin.makaleler.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input class="form-control" name="title" id="makaleBasligi" type="text" placeholder="Makale Başlığı" data-sb-validations="required" />
                    ...
                    <div class="form-floating mb-3">
                        <label for="makaleFotografi">Makale Fotoğrafı</label>
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <textarea class="form-control" name="contents" id="makaleIcerigi" type="text" placeholder="Makale İçeriği" style="height: 10rem;" data-sb-validations="required"></textarea>
                    ...
                    <div>
                        <button class="btn btn-primary btn-lg" id="submitButton" type="submit">Makaleyi Oluştur</button>
                    </div>
                </form>
            </div>
        </div>
